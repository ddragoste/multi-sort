...
class _FilterBoxState extends State<FilterBox> {
  ...
  void initState() {
    var listener = () {
      ...
      var newFilteredFields1 =
          widget.filteredFields.where((e) => e.fieldName != widget.fieldName);
      ...
      if (widget.filterDataType == FilterDataType.string) {
        newFilteredFields2 = [
          ...newFilteredFields1,
          FilterFieldString(
              fieldName: widget.fieldName, searchText: controller1.text),
        ];
        ...
        newFilteredFields2 = [
          ...
          FilterFieldNum(
            ...
            from:
                controller1.text != '' ? double.parse(controller1.text) : null,
